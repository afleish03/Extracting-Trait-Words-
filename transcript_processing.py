...
processed_transcripts = [word_tokenize(transcript) for transcript in processed_transcripts] 

#now we have our processed transcripts, from which we can parse out 
#trait words and their context. We will use this to inform our model as to what 
# a trait word is so that it knows what to look for. 
